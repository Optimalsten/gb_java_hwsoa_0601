...
public class LaptopStore  {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop(8, 256, "Windows 10", "Gray"));
        ...
        laptops.add(new Laptop(16, 1024, "Windows 11", "White"));

        laptops.add(new Laptop(8, 512, "Ubuntu", "Gray"));
        laptops.add(new Laptop(8, 256, "Ubuntu", "Black"));

        laptops.add(new Laptop(32, 1024, "macOS", "Gray"));
        laptops.add(new Laptop(32, 2056, "macOS", "Gray"));
        ...
        while (continueFiltering) {
            ...
            switch (criterion) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("Введите операционную систему (Windows 10, Windows 11, Ubuntu, macOS): ");
                    filters.put("os", scanner.nextLine());
                    break;
                case 4:
                    System.out.print("Введите цвет (Black, Gray, Silver, White): ");
